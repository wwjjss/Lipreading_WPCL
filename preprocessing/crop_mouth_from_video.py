...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--video-direc', default='../lrw/lipread_mp4', help='raw video directory')
    ...
    parser.add_argument('--save-direc', default='../datasets/visual_data', help='the directory of saving mouth ROIs')
    # -- mean face utils 20个单词的平均人脸特征点
    parser.add_argument('--mean-face', default='./20words_mean_face.npy', help='mean face pathname')
    # -- mouthROIs utils 裁剪96*96的ROI
